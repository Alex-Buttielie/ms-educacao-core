...
CREATE TABLE IF NOT EXISTS QUANTIDADE_EQUIPAMENTOS_PROCESSO_APRENDIZAGEM
(
    id                            INTEGER PRIMARY KEY DEFAULT nextval('QUANTIDADE_EQUIPAMENTOS_PROCESSO_APRENDIZAGEM_ID_SEQ'),
